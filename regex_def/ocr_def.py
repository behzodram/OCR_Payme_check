...
from regex_def.ocr_def_ru import extract_payment_info_ru
from regex_def.ocr_def_uz import extract_payment_info_uz
from regex_def.ocr_def_en import extract_payment_info_en
